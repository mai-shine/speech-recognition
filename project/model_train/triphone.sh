...
mkdir triphone/hmm6
HHEd -B -H monophone/hmm5/macros -H monophone/hmm5/hmmdefs -M triphone/hmm6 mktri.hed monophone/monophones0

# run for duration mode
#HHEd -B -H monophone/hmm5/macros -H monophone/hmm5/hmmdefs.dur -M triphone/hmm6 mktri.hed monophone/monophones0
...
#-S train.scp -H monophone/hmm5/macros -H monophone/hmm5/hmmdefs -M triphone/hmm6 \
